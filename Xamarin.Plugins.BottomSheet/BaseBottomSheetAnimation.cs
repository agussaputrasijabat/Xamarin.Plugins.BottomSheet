...
{
    public class BaseBottomSheetAnimation : Rg.Plugins.Popup.Interfaces.Animations.IPopupAnimation
    {
        double translationHeight = 0;
        public BaseBottomSheetAnimation()
        {

        }
        public BaseBottomSheetAnimation(double translationHeight)
        {
